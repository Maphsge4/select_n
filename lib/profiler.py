...
class FlopsProfiler(object):
    ...
    def start_profile(self, ignore_list=None):
        ...
        def register_module_hooks(module, ignore_list):
            ...
            def start_time_hook(module, input):
                # device_sync()
                module.__start_time__ = Timer()
                module.__start_time__.start()
            ...
            def end_time_hook(module, input, output):
                # device_sync()
                delta_t = module.__start_time__.elapsed(reset=True)
                module.__duration__ += delta_t / 1000.0
            ...
            #     # device_sync()
            #     module.__activation_size__ = output.element_size()*output.nelement()
            #     # print(module.__activation_size__)  # debug
                
                

            # if not hasattr(module, "__save_activation_hook_handle__"):
            #     module.__save_activation_hook_handle__ = module.register_forward_hook(
    ...
    def print_model_profile(self,
        ...
        def flops_repr(module):
            ...
            # # add activation
            # activation = get_module_activation(module)
            # items.append(str(activation))
